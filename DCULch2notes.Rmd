...
3. Cut three function will specify which distance you want to pick as the cut off for clusters. _cutree(hclust.out, h=height)_ __OR__ _cutree(hclust.out, k=# of clusters)_
